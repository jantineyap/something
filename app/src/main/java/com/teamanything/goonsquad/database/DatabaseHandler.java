...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_EMAIL = "email"; // unique key email
    private static final String KEY_NAME = "username"; // John Doe
    private static final String KEY_PASS = "pass"; // pass
    private static final String KEY_USER = "user"; // user email friendsTable
    private static final String KEY_FRIEND = "friends"; // user friendsEmail friendsTable
